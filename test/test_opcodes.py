...
class Test:
    ...
    def assertNotEqual(self, a, b):
        assert a != b
    def assertIsInstance(self, instance, typ):
        assert isinstance(instance, typ)


class OpcodeTest(Test):
...
def test_main():
    ...
    #                          DeprecationWarning)):
        test = OpcodeTest()
        test.test_try_inside_for_loop()
        test.test_raise_class_exceptions()
        test.test_compare_function_objects()
        test.test_modulo_of_string_subclasses()
